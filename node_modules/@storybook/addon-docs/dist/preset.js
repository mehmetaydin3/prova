import CJS_COMPAT_NODE_URL_savkcblj6nq from 'node:url';
import CJS_COMPAT_NODE_PATH_savkcblj6nq from 'node:path';
import CJS_COMPAT_NODE_MODULE_savkcblj6nq from "node:module";

var __filename = CJS_COMPAT_NODE_URL_savkcblj6nq.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_savkcblj6nq.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_savkcblj6nq.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-ARZML2RB.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-E3EIOKE5.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-JZOXMIF2.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-EHNAN34E.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {
