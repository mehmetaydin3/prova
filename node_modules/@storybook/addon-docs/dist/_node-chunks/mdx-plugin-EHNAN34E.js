...
import {
  compile
} from "./chunk-IDHAUUOZ.js";
import "./chunk-TGQYUEFZ.js";
import "./chunk-P3CEN6KC.js";
import {
  __commonJS,
  __toESM
} from "./chunk-ARZML2RB.js";
...
async function mdxPlugin(options) {
  let filter = createFilter(/\.mdx$/), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-E3EIOKE5.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-JZOXMIF2.js")).default;
  return {
