...
import {
  toEstree
} from "../_node-chunks/chunk-7LLVOEUH.js";
import {
  StatusTypeIdMismatchError
} from "../_node-chunks/chunk-6HQOJ6UT.js";
import {
  debounce,
  generateStoryFile,
  getErrorLevel,
  ...
  useStatics,
  withTelemetry
} from "../_node-chunks/chunk-FTTIUZEI.js";
import {
  detectPnp
} from "../_node-chunks/chunk-OX3CM4JO.js";
import "../_node-chunks/chunk-PIP7JPFH.js";
import {
  StorybookError
} from "../_node-chunks/chunk-L2UZ5HNT.js";
import {
  telemetry
} from "../_node-chunks/chunk-DHSNYOX5.js";
import "../_node-chunks/chunk-6GUT6MCE.js";
import {
...
} from "../_node-chunks/chunk-LZBZZS4H.js";
import "../_node-chunks/chunk-DPLFJUYH.js";
import "../_node-chunks/chunk-GWENOU2B.js";
import {
  logger,
  require_pretty_hrtime
} from "../_node-chunks/chunk-ZMMRXEMN.js";
import "../_node-chunks/chunk-EZCM3WOF.js";
import "../_node-chunks/chunk-F3WGD556.js";
import {
  invariant,
  up2 as up
} from "../_node-chunks/chunk-JLF74TUB.js";
import "../_node-chunks/chunk-GUXR4BCU.js";
import {
  importModule,
  resolvePackageDir
} from "../_node-chunks/chunk-5BFW6O7C.js";
import {
  dirname,
  isAbsolute,
  join,
  relative,
  resolve
} from "../_node-chunks/chunk-2P7GQSSJ.js";
import {
  slash
} from "../_node-chunks/chunk-QCBS2UZJ.js";
import "../_node-chunks/chunk-XSAUQ5YP.js";
import {
  Tag
} from "../_node-chunks/chunk-6CVEYJMV.js";
import {
  require_dist
} from "../_node-chunks/chunk-ISYIXRJ6.js";
import {
  require_lib,
  require_src
} from "../_node-chunks/chunk-4UDQ3QY2.js";
import {
  require_picocolors
} from "../_node-chunks/chunk-PCYXWF47.js";
import {
  __commonJS,
  __require,
  __toESM
} from "../_node-chunks/chunk-O4LDIM7M.js";
...
async function getManagerBuilder() {
  return await import("../_node-chunks/builder-manager-6TJY3ZFI.js");
}
  ...
  async function onChangeOrRemove(absolutePath, removed) {
    ...
    !removed && isDirectory(absolutePath) && await Promise.all(
      specifiers.filter((specifier) => importPath.startsWith(specifier.directory)).map(async (specifier) => {
        ...
        ), { globby } = await import("../_node-chunks/globby-QFJ53BYG.js");
...
import { logger as logger5, once } from "storybook/internal/node-logger";
...
var getAttr = (elt, what) => elt.attributes.find((n) => n.type === "JSXAttribute" && n.name.name === what), getAttrValue = (elt, what) => getAttr(elt, what)?.value, getAttrLiteral = (elt, what) => {
  ...
  let store = {
    ...
    metaTags: void 0,
    imports: void 0
  }, { compile } = await import("../_node-chunks/mdx-N42X6CFJ-FM4QGF5I.js");
  await compile(code, {
...
var makeAbsolute = (otherImport, normalizedPath, workingDir) => otherImport.startsWith(".") ? slash(resolve3(workingDir, normalizeStoryPath(join5(dirname2(normalizedPath), otherImport)))) : otherImport, StoryIndexGenerator = class _StoryIndexGenerator {
  ...
  static async findMatchingFiles(specifier, workingDir, ignoreWarnings = !1) {
    ...
    if (cached)
      return cached;
    let pathToSubIndex = {}, globCwd = slash(resolve3(workingDir, specifier.directory)), globPattern = specifier.files.startsWith("!") ? `./${specifier.files}` : specifier.files, { globby } = await import("../_node-chunks/globby-QFJ53BYG.js"), files = await globby(globPattern, {
      absolute: !0,
      cwd: globCwd,
    ...
    return files.length === 0 && !ignoreWarnings && once.warn(
      ...
      if (ext === ".storyshot") {
        ...
        logger5.info(`Skipping ${ext} file ${relativePath}`);
        return;
      }
  ...
  async initialize() {
    (await _StoryIndexGenerator.findMatchingFilesForSpecifiers(
      ...
      ([specifier, cache3]) => this.specifierToCache.set(specifier, cache3)
    );
  ...
  async ensureExtracted({
    ...
    return { entries: this.specifiers.flatMap((specifier) => {
      let cache3 = this.specifierToCache.get(specifier);
      return invariant(
        cache3,
        `specifier does not have a matching cache entry in specifierToCache: ${JSON.stringify(
          specifier
        )}`
      ), Object.values(cache3).flatMap((entry) => entry ? entry.type === "docs" ? [entry] : entry.type === "error" ? [entry] : entry.entries.map((item) => {
        if (item.type === "docs")
          return item;
  ...
  findDependencies(absoluteImports) {
    return [...this.specifierToCache.values()].flatMap(
      (cache3) => Object.entries(cache3).filter(([fileName, cacheEntry]) => !cacheEntry || cacheEntry.type !== "stories" ? !1 : !!absoluteImports.find(
  ...
  async extractDocs(specifier, absolutePath, projectTags = []) {
    ...
    try {
      ...
      throw err && err.source?.match(/mdast-util-mdx-jsx/g) && logger5.warn(
  ...
  async getIndexAndStats() {
    ...
    try {
      ...
      throw this.lastError = err == null || err instanceof Error ? err : void 0, invariant(this.lastError), logger5.warn(`\u{1F6A8} ${this.lastError.toString()}`), this.lastError;
    }
  }
  invalidateAll() {
    this.specifierToCache.forEach((cache3) => {
      Object.keys(cache3).forEach((key) => {
        cache3[key] = !1;
      });
  ...
  invalidate(importPath, removed) {
    ...
    let cacheEntry = cache3[absolutePath];
    ...
    if (removed) {
      ...
      delete cache3[absolutePath];
    } else
      cache3[absolutePath] = !1;
    this.lastIndex = null, this.lastError = null, this.invalidationListeners.forEach((listener) => listener());
  }
...
async function buildStaticStandalone(options) {
  ...
  if (options.outputDir = resolve(options.outputDir), options.configDir = resolve(options.configDir), logger6.step(`Cleaning outputDir: ${import_picocolors4.default.cyan(relative(process.cwd(), options.outputDir))}`), options.outputDir === "/")
  ...
  frameworkName ? corePresets.push(join(frameworkName, "preset")) : options.ignorePreview || logger6.warn(`you have not specified a framework in your ${options.configDir}/main.js`);
  ...
  ), options.debugWebpack && logConfig("Preview webpack config", await previewBuilder.getConfig(fullOptions)), options.ignorePreview ? logger6.info("Not building preview") : logger6.info("Building preview..");
  ...
  if (await Promise.all([
    ...options.ignorePreview ? [] : [
      previewBuilder.build({
        ...
        logger6.trace({ message: "Preview built", time: process.hrtime(startTime) });
        ...
        throw logger6.error("Failed to build the preview"), process.exitCode = 1, error;
      })
    ],
    ...effects
    ...
    try {
      ...
      logger6.debug?.(`Build telemetry failed: ${e instanceof Error ? e.message : String(e)}`);
    }
  logger6.step(`Output directory: ${options.outputDir}`);
}
...
import { deprecate, logger as logger15, prompt } from "storybook/internal/node-logger";
...
function getServerChannel(server, options) {
  let transports = [new ServerChannelTransport(server, options)], channel = new Channel({ transports, async: !0 });
...
async function openInBrowser(address) {
  ...
  errorOccured && logger8.error(import_ts_dedent4.dedent`
...
async function storybookDevServer(options) {
  ...
  let serverChannel = await options.presets.apply(
    ...
    getServerChannel(server, {
      token: core2.channelOptions.wsToken,
      host: options.host,
      allowedHosts: core2?.allowedHosts,
  ...
  if (registerIndexJsonRoute({
    ...
    workingDir,
    configDir
  }), app.use(build_default({ level: 1 })), typeof options.extendServer == "function" && options.extendServer(server), app.use(
  ...
  ), app.use(getAccessControlMiddleware(core2?.crossOriginIsolated ?? !1)), app.use(getCachingMiddleware()), (await getMiddleware(options.configDir))(app), await options.presets.apply("experimental_devServer", app), !core2?.builder)
  ...
  return core2?.disableTelemetry || (process.on("SIGINT", cancelTelemetry), process.on("SIGTERM", cancelTelemetry)), { previewResult, managerResult };
}
...
function outputStartupInformation(options) {
  let {
    ...
    managerTotalTime,
    previewTotalTime
  } = options, otherAllowedHosts = allowedHosts === !0 ? "all (insecure)" : allowedHosts?.length ? allowedHosts.join(", ") : void 0, updateMessage = createUpdateMessage(updateInfo, version), serverMessages = [
    `- Local:                ${address}`,
...
var getServerPort = (port, { exactPort } = {}) => (0, import_detect_port.default)(port).then((freePort) => (freePort !== port && exactPort && process.exit(-1), freePort)).catch((error) => {
  logger12.error(error), process.exit(-1);
...
var checkPackageCompatibility = async (dependency, context) => {
  ...
  try {
    ...
    return skipErrors || logger13.log(
...
var warnOnIncompatibleAddons = async (currentStorybookVersion, packageManager) => {
  ...
  incompatiblePackagesMessage && logger14.warn(incompatiblePackagesMessage);
};
...
async function buildDevStandalone(options) {
  ...
  options.smokeTest && (outputDir = cacheOutputDir), invariant(port, "expected options to have a port");
  ...
  options.port = port, options.versionCheck = versionCheck, options.configType = "DEVELOPMENT", options.configDir = configDir, options.cacheKey = cacheKey, options.outputDir = outputDir, options.serverChannelUrl = getServerChannelUrl(port, options), options.localAddress = localAddress, options.networkAddress = networkAddress, options.pnp = await detectPnp(), options.pnp && deprecate(import_ts_dedent8.dedent`
  ...
  try {
    ...
    logger15.warn("Storybook failed to check addon compatibility"), logger15.debug(`${e instanceof Error ? e.stack : String(e)}`);
  }
  try {
  ...
  let presets = await loadAllPresets2({
    ...
    ...options,
    isCritical: !0
  }), { allowedHosts, renderer, builder, disableTelemetry } = await presets.apply("core", {});
  if (options.host === "0.0.0.0" && (!allowedHosts || allowedHosts !== !0 && allowedHosts.length === 0) && logger15.warn(import_ts_dedent8.dedent`
  ...
  if (options.smokeTest) {
    ...
    logger15.log(problems.map((p) => p.stack).join(`
...
var buildIndex = async (options) => {
  ...
  logger16.info(`Writing index to ${options.outputFile}`), await writeFile4(options.outputFile, JSON.stringify(index));
};
