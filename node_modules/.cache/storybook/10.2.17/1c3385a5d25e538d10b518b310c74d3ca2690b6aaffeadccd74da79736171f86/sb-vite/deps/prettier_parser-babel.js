...
`) + N;
          ...
          function p(t) {
            ...
            let r = {};
            for (let e of Object.keys(h)) r[e] = t && t[e] != null ? t[e] : h[e];
            return r;
          }
          var d = class {
            constructor(t, r) {
          ...
          function ot(t, r) {
            ...
            for (a = 0; a < s.length; a++) i = s[a], !(r.indexOf(i) >= 0) && (e[i] = t[i]);
            return e;
          }
          var ge = class {
            constructor(t, r, e) {
...
- Did you mean \`import { "${r}" as foo }\`?`;
          ...
          function Kt(t, r) {
            ...
            for (let s = 0, i = r.length; s < i; s += 2) {
              if (e += r[s], e > t) return false;
              if (e += r[s + 1], e >= t) return true;
            }
            return false;
          }
          function fe(t) {
          ...
          var Fe = 0, Le = 1, de = 2, Gt = 4, gr = 8, ht = 16, Pr = 32, Ee = 64, ut = 128, Oe = 256, ct = Le | de | ut | Oe, le = 1, Ce = 2, Ar = 4, be = 8, pt = 16, Tr = 64, ft = 128, Jt = 256, Xt = 512, Yt = 1024, Qt = 2048, Ve = 4096, dt = 8192, vr = le | Ce | be | ft | dt, Be = le | 0 | be | dt, cl = le | 0 | be | 0, mt = le | 0 | Ar | 0, Er = le | 0 | pt | 0, pl = 0 | Ce | 0 | ft, fl = 0 | Ce | 0 | 0, Cr = le | Ce | be | Jt | dt, br = 0 | Yt, Pe = 0 | Tr, dl = le | 0 | 0 | Tr, ml = Cr | Xt, yl = 0 | Yt, Sr = 0 | Ce | 0 | Ve, xl = Qt, yt = 4, Zt = 2, es = 1, ts = Zt | es, gl = Zt | yt, Pl = es | yt, Al = Zt, Tl = es, ss = 0, rs = class {
            ...
            declareName(t, r, e) {
              ...
              if (r & be || r & pt) this.checkRedeclarationInScope(s, t, r, e), r & pt ? s.functions.add(t) : s.lexical.add(t), r & be && this.maybeExportDefined(s, t);
              else if (r & Ar) for (let i = this.scopeStack.length - 1; i >= 0 && (s = this.scopeStack[i], this.checkRedeclarationInScope(s, t, r, e), s.var.add(t), this.maybeExportDefined(s, t), !(s.flags & ct)); --i) ;
            ...
            hasPlugin(t) {
              ...
              {
                let [r, e] = t;
                if (!this.hasPlugin(r)) return false;
          ...
          var Sl = class extends Cl {
            ...
            processComment(t) {
              ...
              for (; s >= 0; s--) {
                let n = r[s], o = n.end;
                if (o > a) n.containingNode = t, this.finalizeComment(n), r.splice(s, 1);
                else {
            ...
            finalizeComment(t) {
              let { comments: r } = t;
              if (t.leadingNode !== null || t.trailingNode !== null) t.leadingNode !== null && wr(t.leadingNode, r), t.trailingNode !== null && bl(t.trailingNode, r);
              else {
...
`);
          ...
          function Fr(t, r, e, s, i, a, n, o, u, c) {
            ...
            for (let j = 0, K = a == null ? 1 / 0 : a; j < K; ++j) {
              ...
              if (W >= 97 ? V = W - 97 + 10 : W >= 65 ? V = W - 65 + 10 : Nl(W) ? V = W - 48 : V = 1 / 0, V >= i) {
                if (V <= 9 && c) return { n: null, pos: r };
                if (V <= 9 && u.invalidDigit(r, e, s, i)) V = 0;
          ...
          function Lr(t, r, e, s, i, a) {
            ...
            if (n === 123) {
              if (++r, { code: o, pos: r } = os(t, r, e, s, t.indexOf("}", r) - r, true, i, a), ++r, o !== null && o > 1114111) if (i) a.invalidCodePoint(r, e, s);
              else return { code: null, pos: r };
            } else ({ code: o, pos: r } = os(t, r, e, s, 4, false, i, a));
            return { code: o, pos: r };
          }
          var Fl = ["at"], Ll = ["at"];
          function Je(t, r, e) {
          ...
          var Ol = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]), Ae = class {
            ...
            readToken_numberSign() {
              ...
              if (r >= 48 && r <= 57) throw this.raise(f.UnexpectedDigitAfterHash, { at: this.state.curPosition() });
              if (r === 123 || r === 91 && this.hasPlugin("recordAndTuple")) {
                if (this.expectPlugin("recordAndTuple"), this.getPluginOption("recordAndTuple", "syntaxType") === "bar") throw this.raise(r === 123 ? f.RecordExpressionHashIncorrectStartSyntaxType : f.TupleExpressionHashIncorrectStartSyntaxType, { at: this.state.curPosition() });
            ...
            readRegexp() {
              ...
              for (; i < this.length; ) {
                ...
                if (Ol.has(u)) u === 118 ? (this.expectPlugin("regexpUnicodeSets", o()), n.includes("u") && this.raise(f.IncompatibleRegExpUVFlags, { at: o() })) : u === 117 && n.includes("v") && this.raise(f.IncompatibleRegExpUVFlags, { at: o() }), n.includes(c) && this.raise(f.DuplicateRegExpFlags, { at: o() });
            ...
            readRadixNumber(t) {
              ...
              else if (i === 109) throw this.raise(f.InvalidDecimal, { at: r });
            ...
            expectOnePlugin(t) {
              if (!t.some((r) => this.hasPlugin(r))) throw this.raise(f.MissingOneOfPlugins, { at: this.state.startLoc, missingPlugin: t });
            }
            errorBuilder(t) {
              return (r, e, s) => {
            ...
            exit() {
              ...
              for (let [e, s] of Array.from(t.undefinedPrivateNames)) r ? r.undefinedPrivateNames.has(e) || r.undefinedPrivateNames.set(e, s) : this.parser.raise(f.InvalidPrivateFieldResolution, { at: s, identifierName: e });
            }
            ...
            recordAsyncArrowParametersError(t) {
              ...
              for (; i.canBeArrowParameterDeclaration(); ) i.type === ls && i.recordDeclarationError(f.AwaitBindingIdentifier, { at: r }), i = e[--s];
            }
            validateAsPattern() {
          ...
          var zl = class extends Bl {
            ...
            expectContextual(t, r) {
              if (!this.eatContextual(t)) {
                if (r != null) throw this.raise(r, { at: this.state.startLoc });
            ...
            tryParse(t) {
              ...
              try {
                ...
                let i = this.state;
                if (this.state = r, s instanceof SyntaxError) return { node: null, error: s, thrown: true, aborted: false, failState: i };
          ...
          function Yl(t, r) {
            let e = [], s = [];
            for (let i = 0; i < t.length; i++) (r(t[i], i, t) ? e : s).push(t[i]);
            return [e, s];
          }
          var Ql = /\*?\s*@((?:no)?flow)\b/, Zl = (t) => class extends t {
            ...
            flowParseObjectType(e) {
              ...
              for (i && this.match(6) ? (this.expect(6), y = 9, g = true) : (this.expect(5), y = 8, g = false), c.exact = g; !this.match(y); ) {
                ...
                if (this.eat(0)) j != null && this.unexpected(j), this.eat(0) ? (V && this.unexpected(V.loc.start), c.internalSlots.push(this.flowParseObjectTypeInternalSlot(W, M))) : c.indexers.push(this.flowParseObjectTypeIndexer(W, M, V));
                else if (this.match(10) || this.match(47)) j != null && this.unexpected(j), V && this.unexpected(V.loc.start), c.callProperties.push(this.flowParseObjectTypeCallProperty(W, M));
                else {
                  let X = "init";
            ...
            parseMaybeAssign(e, s) {
              ...
              if ((i = n) != null && i.error || this.match(47)) {
                ...
                if (y.node && this.maybeUnwrapTypeCastExpression(y.node).type === "ArrowFunctionExpression") {
                  if (!y.error && !y.aborted) return y.node.async && this.raise(D.UnexpectedTypeParameterBeforeAsyncArrowFunction, { at: c }), y.node;
                  g = y.node;
                }
            ...
            flowEnumBody(e, s) {
              ...
              switch (e.hasUnknownMembers = u, n) {
                ...
                default: {
                  ...
                  } else return this.raise(D.EnumInconsistentMemberValues, { at: a, enumName: i }), c();
                }
              }
            }
...
`) : i = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, i;
          ...
          var uh = (t) => class extends t {
            ...
            tsParseTupleElementType() {
              ...
              if (c === 58) i = true, n = false, a = this.parseIdentifier(true), this.expect(14), o = this.tsParseType();
              else if (c === 63) {
                n = true;
            ...
            parseTypeOnlyImportExportSpecifier(e, s, i) {
              ...
              if (this.isContextual(93)) {
                ...
                } else te(this.state.type) ? (y = false, u = s ? this.parseIdentifier() : this.parseModuleExportName()) : (c = true, o = C);
              } else te(this.state.type) && (c = true, s ? (o = this.parseIdentifier(true), this.isContextual(93) || this.checkReservedWord(o.name, o.loc.start, true, true)) : o = this.parseModuleExportName());
          ...
          function J(t, r) {
            ...
            return t.some((n) => {
              if (typeof n == "string") return a && n === e;
              {
                let [o, u] = n;
                if (o !== e) return false;
                for (let c of i) if (u[c] !== s[c]) return false;
                return true;
              }
            });
          }
          ...
          function yh(t) {
            ...
            if (J(t, "pipelineOperator")) {
              ...
              } else if (r === "smart" && e) throw new Error('Plugin conflict between `["pipelineOperator", { proposal: "smart" }]` and `["recordAndtuple", { syntaxType: "hash"}]`.');
            }
            ...
            if (J(t, "recordAndTuple") && we(t, "recordAndTuple", "syntaxType") != null && !Jr.includes(we(t, "recordAndTuple", "syntaxType"))) throw new Error("The 'syntaxType' option of the 'recordAndTuple' plugin must be one of: " + Jr.map((r) => `'${r}'`).join(", "));
          ...
          var Xr = { estree: el, jsx: th, flow: Zl, typescript: uh, v8intrinsic: mh, placeholders: dh }, xh = Object.keys(Xr), gh = class extends ah {
            ...
            parseExprOp(t, r, e) {
              ...
              if (_o(s) && (this.prodParam.hasIn || !this.match(58))) {
                ...
                if (i > e) {
                  ...
                  if (o && (c === 41 || c === 42) || n && c === 40) throw this.raise(f.MixingCoalesceWithLogical, { at: this.state.startLoc });
            ...
            finishTopicReference(t, r, e, s) {
              ...
              } else throw this.raise(f.PipeTopicUnconfiguredToken, { at: r, token: xe(s) });
            }
            ...
            wrapParenthesis(t, r) {
              if (!this.options.createParenthesizedExpressions) return this.addExtra(r, "parenthesized", true), this.addExtra(r, "parenStart", t.index), this.takeSurroundingComments(r, t.index, this.state.lastTokEndLoc.index), r;
...
`), cooked: i === null ? null : i.slice(1, u) }, n.tail = o, this.next();
            ...
            parseTemplate(t) {
              ...
              for (r.quasis = [e]; !e.tail; ) r.expressions.push(this.parseTemplateSubstitution()), this.readTemplateContinuation(), r.quasis.push(e = this.parseTemplateElement(t));
            ...
            parsePropertyDefinition(t) {
              let r = [];
              if (this.match(26)) for (this.hasPlugin("decorators") && this.raise(f.UnsupportedPropertyDecorator, { at: this.state.startLoc }); this.match(26); ) r.push(this.parseDecorator());
            ...
            parseObjectMethod(t, r, e, s, i) {
              ...
              if (e || r || this.match(10)) return s && this.unexpected(), t.kind = "method", t.method = true, this.parseMethod(t, r, e, false, false, "ObjectMethod");
            }
            parseObjectProperty(t, r, e, s) {
              ...
              if (!t.computed && t.key.type === "Identifier") {
                if (this.checkReservedWord(t.key.name, t.key.loc.start, true, false), e) t.value = this.parseMaybeDefault(r, me(t.key));
            ...
            parseFunctionBody(t, r) {
              ...
              if (this.expressionScope.enter(_r()), s) t.body = this.parseMaybeAssign(), this.checkParams(t, false, r, false);
              else {
            ...
            isSimpleParamList(t) {
              for (let r = 0, e = t.length; r < e; r++) if (!this.isSimpleParameter(t[r])) return false;
              return true;
            }
            checkParams(t, r, e) {
          ...
          var vh = class extends gh {
            ...
            parseProgram(t) {
              ...
              if (t.sourceType = e, t.interpreter = this.parseInterpreterDirective(), this.parseBlockBody(t, true, true, r), this.inModule && !this.options.allowUndeclaredExports && this.scope.undefinedExports.size > 0) for (let [i, a] of Array.from(this.scope.undefinedExports)) this.raise(f.ModuleExportUndefined, { at: a, localName: i });
              let s;
            ...
            parseLabeledStatement(t, r, e, s) {
              for (let a of this.state.labels) a.name === r && this.raise(f.LabelRedeclaration, { at: e, labelName: r });
            ...
            parseClassBody(t, r) {
              ...
              }), this.state.strict = r, this.next(), s.length) throw this.raise(f.TrailingDecorator, { at: this.state.startLoc });
            ...
            parseClassId(t, r, e) {
              ...
              if (q(this.state.type)) t.id = this.parseIdentifier(), r && this.declareNameFromIdentifier(t.id, s);
              else if (e || !r) t.id = null;
            ...
            parseExport(t, r) {
              ...
              if (i && !a) {
                if (e && this.unexpected(), r) throw this.raise(f.UnsupportedDecoratorExport, { at: t });
              ...
              let c;
              if (o || u) {
                if (c = false, r) throw this.raise(f.UnsupportedDecoratorExport, { at: t });
                this.parseExportFrom(t, o);
              } else c = this.maybeParseExportDeclaration(t);
              if (o || u || c) {
                var y;
                let g = t;
                if (this.checkExport(g, true, false, !!g.source), ((y = g.declaration) == null ? void 0 : y.type) === "ClassDeclaration") this.maybeTakeDecorators(r, g.declaration, g);
                else if (r) throw this.raise(f.UnsupportedDecoratorExport, { at: t });
                return this.finishNode(g, "ExportNamedDeclaration");
              }
              if (this.eat(65)) {
                let g = t, T = this.parseExportDefaultExpression();
                if (g.declaration = T, T.type === "ClassDeclaration") this.maybeTakeDecorators(r, T, g);
                else if (r) throw this.raise(f.UnsupportedDecoratorExport, { at: t });
            ...
            isExportDefaultSpecifier() {
              ...
              if (this.input.charCodeAt(r) === 44 || q(this.state.type) && e) return true;
              if (this.match(65) && e) {
            ...
            checkDeclaration(t) {
              ...
              else if (t.type === "ObjectPattern") for (let r of t.properties) this.checkDeclaration(r);
              else if (t.type === "ArrayPattern") for (let r of t.elements) r && this.checkDeclaration(r);
            ...
            parseAssertEntries() {
              ...
              do {
                ...
                let e = this.startNode(), s = this.state.value;
                if (r.has(s) && this.raise(f.ModuleAttributesWithDuplicateKeys, { at: this.state.startLoc, key: s }), r.add(s), this.match(131) ? e.key = this.parseStringLiteral(s) : e.key = this.parseIdentifier(true), this.expect(14), !this.match(131)) throw this.raise(f.ModuleAttributeInvalidValue, { at: this.state.startLoc });
            ...
            maybeParseModuleAttributes() {
              ...
              do {
                let e = this.startNode();
                if (e.key = this.parseIdentifier(true), e.key.name !== "type" && this.raise(f.ModuleAttributeDifferentFromType, { at: e.key }), r.has(e.key.name) && this.raise(f.ModuleAttributesWithDuplicateKeys, { at: e.key, key: e.key.name }), r.add(e.key.name), this.expect(14), !this.match(131)) throw this.raise(f.ModuleAttributeInvalidValue, { at: this.state.startLoc });
            ...
            parseImportSpecifier(t, r, e, s, i) {
              if (this.eatContextual(93)) t.local = this.parseIdentifier();
                ...
                let { imported: a } = t;
                if (r) throw this.raise(f.ImportBindingIsString, { at: t, importName: a.value });
          ...
          function Sh(t) {
            let r = {};
            for (let e of Object.keys(t)) r[e] = ce(t[e]);
            return r;
          }
          var wh = Sh(Z);
          function Xe(t, r) {
